    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Mita Anggraeni");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 19);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Mita Anggraeni");
                mPerson.setAge(19);
                mPerson.setEmail("mitaanggraeni501@gmail.com");
                mPerson.setCity("Pringsewu, Lampung");
                Intent moveWithObjectIntent = new Intent(MainActivity.this, MoveWithObjectActivity.class);
                moveWithObjectIntent.putExtra(MoveWithObjectActivity.EXTRA_PERSON, mPerson);
                startActivity(moveWithObjectIntent);
                break;
            case R.id.btn_dial_number:
                String phoneNumber = "085279779008";
